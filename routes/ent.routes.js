...
router.get("/details/:id", (req, res) => {
  ...
  Ent.findById(id)    
  .then( ent => res.render("entertainment/details", ent ))
})
...
router.post("/edit/:id", (req, res) => {
  ...
  Ent.findByIdAndUpdate(id, { name, type, music, musicType, price, review, location, webSite, openingTime, closingTime })
